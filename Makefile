...
all: vuln.s vuln driver driver_authd_expl driver_smash_data driver_smash_libc driver_smash_ex_injected driver_smash_extra_BP driver_heap driver_heap_extra driver_string
...
driver_smash_ex_injected: driver_smash_ex_injected.c
	gcc $(CFLAGS) -o driver_smash_ex_injected driver_smash_ex_injected.c
...
clean:
	rm -f vuln vuln.o my_malloc.o vuln.s padding.h driver_authd_expl driver driver_smash_data driver_smash_libc driver_smash_ex_injected driver_smash_extra_BP driver_heap driver_heap_extra driver_string
